...
export default function Na(props) {
  return (
    <nav
      className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode} fixednav`}
    >
      <div className="container-fluid">

        <Link className="navbar-brand textdark" to="/">
          {props.title}
        </Link>
        ...
        <div className="collapse navbar-collapse" id="navbarNavDropdown">
          <ul className="navbar-nav">
            ...
            <li className="nav-item dropdown">
              {/* ✅ FIXED: Remove href="#" and use button instead */}
              <button
          ...
          <form className="d-flex align-items-center ms-auto">
            ...
            <div className="form-check form-switch ms-3">
              ...
              />
              <label
                className="form-check-label textcont ms-1"
